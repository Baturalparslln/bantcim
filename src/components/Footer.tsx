      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          <div className="lg:col-span-1">
            <Link href="/" className="flex items-center gap-2.5 mb-5 no-underline">
              <span className="relative inline-block leading-none pb-1">
                <span className="block text-[1.8rem] font-black tracking-[-0.06em] text-white">
                  Bant<span className="text-primary-300">cım</span>
                </span>
            ...
            <p className="text-slate-400 text-sm leading-relaxed max-w-xs">
              Konveyör bant alıcılarını ve satıcılarını güvenle buluşturan
              profesyonel aracı platform.
            </p>
          </div>
        ...
        <div className="border-t border-slate-800 mt-12 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4">
            <span className="text-slate-600 text-xs">Gizlilik Politikası</span>
            <span className="text-slate-700">·</span>
            <span className="text-slate-600 text-xs">Kullanım Koşulları</span>
          </div>
        </div>
      </div>
    </footer>
