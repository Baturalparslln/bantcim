                ...
                <div className="space-y-8">
                  <div>
                    ...
                    <p className="text-slate-500 leading-relaxed text-sm">
                      Konveyör bant satışı veya alımı hakkında bilgi almak, platformumuza üye olmak veya herhangi bir sorunuz için bize yazabilirsiniz.
                    </p>
                  </div>
                  ...
                  <div className="space-y-5">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-slate-500 text-sm">info@bantcim.com</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-slate-500 text-sm">+90 (212) 000 00 00</p>
                      </div>
                    </div>
